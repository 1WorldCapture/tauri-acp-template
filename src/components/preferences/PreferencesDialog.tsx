...
import { Settings, Palette, Puzzle, Zap } from 'lucide-react'
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
type PreferencePane = 'general' | 'appearance' | 'providers' | 'advanced'
...
const navigationItems = [
  ...
  },
  {
    ...
    labelKey: 'preferences.providers',
    icon: Puzzle,
  },
  {
        ...
        <SidebarProvider className="items-start">
          ...
          <main className="flex flex-1 flex-col overflow-hidden">
            ...
            <div className="flex flex-1 flex-col gap-4 overflow-y-auto p-4 pt-0 max-h-[calc(600px-4rem)]">
              ...
              {activePane === 'providers' && <ProviderPane />}
